package promind.cleaner.app.core.adsControl;
...
public class AdmobHelp {
    ...
    public void init(Context context) {
        appId = BuildConfig.DEBUG ? context.getString(R.string.admob_app_id_debug) : context.getString(R.string.admob_app_id);
        bannerId = BuildConfig.DEBUG ? context.getString(R.string.admob_banner_debug) : context.getString(R.string.admob_banner);
        interId = BuildConfig.DEBUG ? context.getString(R.string.admob_full_debug) : context.getString(R.string.admob_full);
        nativeId = BuildConfig.DEBUG ? context.getString(R.string.admob_native_debug) : context.getString(R.string.admob_native);

        MobileAds.initialize(context, appId);
        mPublisherInterstitialAd = new PublisherInterstitialAd(context);
        mPublisherInterstitialAd.setAdUnitId(interId);
    ...
    public void loadNative(final Activity mActivity) {
        ...
        AdLoader adLoader = new AdLoader.Builder(mActivity, nativeId)
