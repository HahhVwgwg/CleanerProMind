...
public class UtilsApp {
    ...
    public static void SendFeedBack(Context mContext, String mEmail, String mEmailTitle) {
        ...
        intentEmail.putExtra(Intent.EXTRA_TEXT, mContext.getResources().getString(R.string.enter_feed));

        try {
            mContext.startActivity(Intent.createChooser(intentEmail, mContext.getResources().getString(R.string.send_feedback)));
        } catch (ActivityNotFoundException e) {
            ShowToastShort(mContext, mContext.getString(R.string.no_email));
        }
    }
    ...
    public static void shareApp(Context context)
    {
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT, context.getString(R.string.checkout_at, appPackageName));
