...
import promind.cleaner.app.core.service.winManager.DeepboostWindowmanager;

import java.util.List;

public class TaskForceStop extends AsyncTask<Void, TaskInfo, Void> {

    private Context mContext;
    private List<TaskInfo> lstApp;

    public TaskForceStop(Context mContext, List<TaskInfo> lstApp) {
