...
public class Toolbox {
    ...
    public static void creatShorCutNormal(Context mContext) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            intent2.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE, Intent.ShortcutIconResource.fromContext(mContext, R.mipmap.ic_launcher));
    ...
    public static void setTextFromSize(long size, TextView tvNumber, TextView tvType, Button button) {
        ...
        tvType.setText(tvType.getText() + " " + tvType.getContext().getString(R.string.found));
    }
