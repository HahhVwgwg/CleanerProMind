...
import promind.cleaner.app.core.data.data.DeleteFilesAsyncTask;
...
import promind.cleaner.app.ui.adapter.RecyclerViewType;
import promind.cleaner.app.ui.adapter.SectionRecyclerViewAdapter;
...
public class DuplicateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(v -> {
            Objects.requireNonNull(LocalListenerKt.getListener()).invoke();
            finish();
        });
    ...
    public void deleteFiles() {
        mDeleteFilesAsyncTask = new DeleteFilesAsyncTask(DuplicateActivity.this, listFile, new DeleteFilesAsyncTask.OnRestoreListener() {
            ...
            public void onComplete() {
                ...
                try {
                    Intent intent = new Intent(DuplicateActivity.this, DeepScanActivity.class);
    ...
    private void SDcardFilesDialog() {
        ...
        main_dialog2.findViewById(R.id.ok_sd).setOnClickListener(new View.OnClickListener() {
    ...
    public void deleteSelectedItem() {
        listFile.clear();
        if (DeepScanActivity.mListData != null) {
            for (int i = 0; i < DeepScanActivity.mListData.size(); i++) {
                ArrayList<Duplicate> listDup = DeepScanActivity.mListData.get(i).getListDuplicate();
    ...
    private void populateRecyclerView() {
        ...
        adapter = new SectionRecyclerViewAdapter(this, recyclerViewType, DeepScanActivity.mListData);
