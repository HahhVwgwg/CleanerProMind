...
public class ScanAppInstallActivity extends BaseActivity {
    ...
    private void initData() throws PackageManager.NameNotFoundException {
        ...
        new TaskScanVirus(this, pkgName, 0, new TaskScanVirus.OnTaskListListener() {
            @Override
            public void OnResult(@NonNull List<TaskInfo> lstDangerous, @NonNull List<TaskInfo> lstVirus) {
    ...
    public String checkVirus(List<? extends TaskInfo> mList) {
        if (mList.isEmpty())
            return null;
